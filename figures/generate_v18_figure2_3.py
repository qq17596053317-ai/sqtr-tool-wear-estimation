...
def figure2() -> None:
    ...
    source_b["ComparatorMinusSQTR"] = source_b["AllTimeMAE"] - source_b["RouteOnlyMAE"]
...
if __name__ == "__main__":
    figure2()
    figure3()
    print(f"Saved v18 Figures 2 and 3 to {OUT}")
